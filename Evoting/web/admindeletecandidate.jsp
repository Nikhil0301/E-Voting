<%-- 
    ...
    Created on : 26 Jun, 2021, 6:04:15 PM
    Author     : hp
--%>
...
<%
    ...
    if (result != null && result.equalsIgnoreCase("candidatelist")) {
        ...
        displayBlock.append("<tr><th>confirm:- </th><td><input type='button' value='Delete Candidate' onclick='delcandidate()' id='delcnd'></td></tr>");
        displayBlock.append("</table>");
