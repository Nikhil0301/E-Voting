<%-- 
    ...
    Created on : 1 Jun, 2021, 8:33:20 PM
    Author     : hp
--%>
    ...
    <body>
        <%
            ...
            for (CandidateInfo c : candidate) {
                displayBlock.append("<h2>This<h2><input id='" + c.getCandidateId() + "' value='" + c.getCandidateId() + "' name='flat' type='radio' onclick='addVote()' />");
                displayBlock.append("<label for='" + c.getCandidateId() + "'><img src='data:image/jpg;base64," + c.getSymbol() + "' style='width:300px;height:200px;'/></label>"
                        ...
                        + "<label>Party:" + c.getParty() + "</label><br/></div>");
            }
            ...
            for(CandidateInfo c:candidateList){
                ...
                displayBlock.append("<label for='"+c.getCandidateId()+"'><img src='data:img/jpg;base64,"+c.getSymbol()+"' style='width:300px;height:200px;'/></label>");
