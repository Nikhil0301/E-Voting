...
public class VotingControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            try
            {
                ...
                if(cid==null)
                {
                    System.out.println("here we are in votingcontrollerservlet and cid is:- "+cid);
                    System.out.println("user_id is:- "+userid);   
                    ArrayList<CandidateInfo> candidateList = CandidateDAO.viewCandidate(userid);
//                    CandidateInfo cifo=candidateList.get(0);
//                    System.out.println(cifo.getCandidateId()+","+cifo.getCandidateName()+","+cifo.getParty());
